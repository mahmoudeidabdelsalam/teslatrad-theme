...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  ?>
    <header class="entry-header">
      ...
      <p><time datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished"><?php echo get_the_date(); ?></time> <strong class="ml-4 mr-4"><?php _e('by', 'teslatradeltd'); ?> <?= get_the_author_meta( 'nicename', $author_id ); ?></strong></p>
